package com.luffy.generalratingbarlib.base;
 ...
 * @desc 局部视图（五星、红星等替换）
 */
public class RatingBarPartialView extends RelativeLayout {
    ...
    public RatingBarPartialView(Context context, int starWidth, int startHeight) {
        super(context);
    ...
    public RatingBarPartialView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public RatingBarPartialView(Context context, AttributeSet attrs, int defStyleAttr) {
