package com.luffy.view.generaltaglib;
...
import com.luffy.generaltaglib.R;
...
public class TagView extends ViewGroup {
    ...
    private static final int DEFAULT_TEXT_BACKGROUND = R.drawable.shape_trainlist_rounded_corners;
    ...
    private int getMultiTotalHeight(int totalWidth, int totalHeight) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (totalWidth + mTagBorderHor + mViewBorder > sizeWidth) {
                ...
                child.layout(totalWidth + mTagBorderHor,
                        totalHeight - childHeight,
                        totalWidth + childWidth + mTagBorderHor,
                        totalHeight);
                totalWidth += childWidth;
