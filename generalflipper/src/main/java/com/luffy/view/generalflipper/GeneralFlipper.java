...
import com.luffy.generalflipper.R;
...
public class GeneralFlipper extends BaseCombinationView {
    ...
    public void initAttrs(AttributeSet attrs) {
        ...
        /*是否显示*/
        flipper_left_icon_visibility = attributes.getInt(R.styleable.GeneralFlipper_flipper_left_icon_visibility, View.GONE);
        ...
        /*是否显示*/
        flipper_right_icon_visibility = attributes.getInt(R.styleable.GeneralFlipper_flipper_right_icon_visibility, View.GONE);
    ...
    public void bindAttrs() {
        ...
        /*宽高、外边距*/
        LinearLayout.LayoutParams paramsFlipperRoot = (LinearLayout.LayoutParams) flipperRoot.getLayoutParams();
        ...
        /**左边图片*/
        /*宽高、外边距*/
        LinearLayout.LayoutParams paramsFlipperLeftIcon = (LinearLayout.LayoutParams) flipperLeftIcon.getLayoutParams();
        ...
        switch (flipper_left_icon_visibility) {
            case 1:
                flipperLeftIcon.setVisibility(View.VISIBLE);
                break;
            case 2:
                flipperLeftIcon.setVisibility(View.GONE);
                break;
            case 3:
                flipperLeftIcon.setVisibility(View.INVISIBLE);
                break;
        }

        /**右边图片*/
        /*宽高、外边距*/
        LinearLayout.LayoutParams paramsFlipperRightIcon = (LinearLayout.LayoutParams) flipperRightIcon.getLayoutParams();
        ...
        switch (flipper_right_icon_visibility) {
            case 1:
                flipperRightIcon.setVisibility(View.VISIBLE);
                break;
            case 2:
                flipperRightIcon.setVisibility(View.GONE);
                break;
            case 3:
                flipperRightIcon.setVisibility(View.INVISIBLE);
                break;
        }
