...
import com.luffy.generalbuttonlib.R;
...
public class GeneralButton extends BaseCombinationView {
    ...
    public void initAttrs(AttributeSet attrs) {
        ...
        //布局宽高
        button_root_width = attributes.getDimensionPixelSize(R.styleable.GeneralButton_button_root_width, LinearLayout.LayoutParams.MATCH_PARENT);
        button_root_height = attributes.getDimensionPixelSize(R.styleable.GeneralButton_button_root_height, LinearLayout.LayoutParams.WRAP_CONTENT);
        //是否可点击
    ...
    public void bindAttrs() {
        /*根布局*/
        //宽高
        LinearLayout.LayoutParams paramsButtonRoot = (LinearLayout.LayoutParams) layout.getLayoutParams();
